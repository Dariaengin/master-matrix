...
exports.getAllPosts = async (req, res) => {
  try {
    const post = await Post.find().populate('comments');//Looks for all documents (posts) in DB, returns an array of posts and replaces those ObjectIds with the actual comment 
